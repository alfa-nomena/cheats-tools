...
HTTP
    ...
    # directory busting
    gobuster dir -w /usr/share/wordlists/dirb/common.txt -r -t40 -u <URL>
    gobuster dir -w /usr/share/wordlists/dirb/common.txt -U <USERNAME> -P <PASSWORD> -r -t40 -u <URL>
    gobuster dir -w /usr/share/wordlists/dirbuster/directory-list-2.3-medium.txt -r -t40 -u <URL> # linux
